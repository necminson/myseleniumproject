...
public class TC01_RegisterUserTest extends TestBase {
    ...
    public void RegisterUserTest(){
      ...
      Faker faker = new Faker(); // By using faker object we can generate data, like fake firstname, fake lastname etc.
      ...
      //  6. Enter name and email address
       ...
       // 12. Fill details: First name, Last name, Company, Address, Address2, Country, State, City, Zipcode, Mobile Number
        ...
        String username = driver.findElement(By.xpath("(//a)[11]")).getText();
